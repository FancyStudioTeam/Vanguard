...
export function PanelsEmptyState() {
	return (
		<section className='flex h-75 items-center justify-center rounded-xl border-2 border-neutral-800 border-dashed p-6'>
			<section className='flex w-full max-w-xs flex-col gap-2 text-center'>
				...
				<p className='text-neutral-400 text-sm'>You can start by creating a panel to manage your tickets.</p>
			</section>
		</section>
	);
}
